...
export default function Order() {
  const locations = [
    ...
    },
    {
      ...
      ubereatsLink:
        "https://www.ubereats.com/store/demiya-de-anza-blvd/ArVjGu43T1yi8lU9regVYQ?diningMode=DELIVERY",
    },
    {
      name: "DUBLIN",
    ...
    },
    {
      ...
      doordashLink:
        "https://www.doordash.com/en-AU/store/demiya-fremont-31282911/",
      ubereatsLink:
        "https://www.ubereats.com/store/demiya-fremont-em/aqjfiPLdQoCy7NTnFVmA9g",
    },
  ];

  const emeryville = locations.find((l) => l.name === "EMERYVILLE");
  const others = locations.filter((l) => l.name !== "EMERYVILLE");
    ...
    <Layout>
      ...
      <div className={styles.centeredEmeryville}>
        <div className={styles.location}>
          ...
          <Link href={emeryville.orderLink}>Online order</Link>
          <p>{emeryville.address}</p>
          <div className={styles.mapContainer}>
            <iframe
              src={emeryville.mapSrc}
              frameBorder="0"
              allowFullScreen
              title={emeryville.name}
            ></iframe>
          </div>
        </div>
      </div>
